...
const translations = {
    ar: {
        ...
        hero_diff: 'لا نفرض حلولاً جاهزة — ندخل مؤسستك، نفهم كيف تعمل فعلاً، ثم نبني ما يناسبها',
        hero_cta: 'اكتشف خدماتنا',
        about_badge: 'من نحن',
        about_title: 'نوع جديد من شركات التقنية',
        about_p1: 'المؤسسات لا تتأخّر تقنياً لأن الحلول غير موجودة — بل لأن أحداً لم يأخذ الوقت ليفهم كيف تعمل هذه المؤسسات فعلاً قبل أن يقترح حلاً.',
        about_p2: 'GEO تغيّر هذه المعادلة. نندمج داخل مؤسستك، نعيش يومها، نشخّص الفجوات الحقيقية، ثم نصمّم وننفّذ أنظمة صُنعت لواقعك — لا أدوات عامّة فُرضت على بيئة لا تناسبها. نتحمّل المسؤولية الكاملة: من التشخيص إلى التسليم والدعم المستمر.',
        ...
        m_step1_title: 'الاندماج', m_step1_tag: 'نعيش واقعك قبل أن نصمّم شيئاً', m_step1_desc: 'نرسل متخصصينا إلى داخل مؤسستك. يجلسون مع كل قسم، يراقبون العمليات اليومية، يوثّقون سير العمل بالتفصيل — لأسبوعين إلى ثلاثة أسابيع.', m_step1_en: 'EMBED',
        m_step2_title: 'التشخيص', m_step2_tag: 'نحدّد المشكلة الحقيقية بدقة جراحية', m_step2_desc: 'يجتمع الفريق كاملاً لمراجعة التقرير التشخيصي. نحدّد أين يمكن للذكاء الاصطناعي وGIS والأمن السيبراني أن تخلق أكبر قيمة، ونضع خطة تدخّل مرتّبة.', m_step2_en: 'DIAGNOSE',
        m_step3_title: 'التصميم', m_step3_tag: 'كل متخصص يبني في مجال تميّزه فقط', m_step3_desc: 'كل متخصص يبني في مجاله: الذكاء الاصطناعي، GIS، الأمن السيبراني، البنية التحتية — بتركيز تام وبدون تداخل. النتيجة: جودة أعلى وسرعة أكبر.', m_step3_en: 'DESIGN',
        m_step4_title: 'التنفيذ', m_step4_tag: 'نسلّم، ندرّب، ونبقى معك', m_step4_desc: 'نسلّم نظاماً مكتملاً مع توثيق شامل وتدريب عملي. ثم نبقى — دعم تقني مستمر يضمن أن النظام يتطوّر مع احتياجاتك.', m_step4_en: 'DELIVER',
        research_badge: 'الأبحاث والابتكار',
        research_title: 'نحن لا نلاحق المستقبل — نستعد له',
        research_desc: 'الذكاء الاصطناعي غيّر قواعد اللعبة. لكن ما هو قادم أضخم بعشر مرات.',
        research_vision: 'الحوسبة الكمومية ليست مجرد تطوّر — إنها قفزة في طريقة الحساب نفسها. بينما يحاول العالم مواكبة الذكاء الاصطناعي، نحن نبني القدرات لما بعده.',
        r_quantum_title: 'الحوسبة الكمومية', r_quantum_desc: 'بناء القدرات والخبرات في الخوارزميات الكمومية — من التحسين والمحاكاة إلى النمذجة الاقتصادية واتخاذ القرار الاستراتيجي',
        r_applied_title: 'ذكاء تطبيقي مُنتَج', r_applied_desc: 'أبحاث تتحوّل إلى حلول جاهزة للبيع — نماذج ذكاء اصطناعي متقدمة مصمّمة لقطاعات السوق العراقي والإقليمي، وليست تمارين أكاديمية',
    ...
    en: {
        ...
        hero_diff: 'We don\'t prescribe solutions — we enter your organization, understand how it actually works, then build what fits',
        hero_cta: 'Explore Our Services',
        about_badge: 'About Us',
        about_title: 'A New Kind of Technology Company',
        about_p1: 'Organizations don\'t fall behind technologically because solutions don\'t exist — they fall behind because no one takes the time to understand how they actually work before proposing a solution.',
        about_p2: 'GEO changes that equation. We embed inside your organization, live its day-to-day, diagnose the real gaps, then design and deliver systems built for your reality — not generic tools forced into environments where they don\'t belong. We take full ownership: from diagnosis to delivery and ongoing support.',
        ...
        m_step1_title: 'Embed', m_step1_tag: 'We live your reality before designing anything', m_step1_desc: 'We send our specialists into your organization. They sit with every department, observe daily operations, and document workflows in detail — for two to three weeks.', m_step1_en: 'EMBED',
        m_step2_title: 'Diagnose', m_step2_tag: 'We identify the real problem with surgical precision', m_step2_desc: 'The full team convenes to review the diagnostic report. We identify where AI, GIS, and cybersecurity can create the most value, and build a prioritized intervention plan.', m_step2_en: 'DIAGNOSE',
        m_step3_title: 'Design', m_step3_tag: 'Each specialist builds only in their domain of excellence', m_step3_desc: 'Each specialist builds in their domain: AI, GIS, cybersecurity, infrastructure — with complete focus and zero overlap. The result: higher quality and faster delivery.', m_step3_en: 'DESIGN',
        m_step4_title: 'Deliver', m_step4_tag: 'We deliver, train, and stay with you', m_step4_desc: 'We deliver a complete system with comprehensive documentation and hands-on training. Then we stay — ongoing technical support ensures the system evolves with your needs.', m_step4_en: 'DELIVER',
        research_badge: 'Research & Innovation',
        research_title: 'We Don\'t Chase the Future — We Prepare for It',
        research_desc: 'AI changed the game. But what\'s coming is ten times bigger.',
        research_vision: 'Quantum computing isn\'t just an evolution — it\'s a leap in the very nature of computation. While the world races to keep up with AI, we\'re building the capabilities for what comes after.',
        r_quantum_title: 'Quantum Computing', r_quantum_desc: 'Building expertise in quantum algorithms — from optimization and simulation to economic modeling and strategic decision-making',
        r_applied_title: 'Applied Productized Intelligence', r_applied_desc: 'Research that becomes ready-to-sell solutions — advanced AI models designed for the Iraqi and regional markets, not academic exercises',
